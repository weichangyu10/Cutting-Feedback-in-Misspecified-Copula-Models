...
muInit.marginal[1:75] <- ReverseVBCopObj$MuStore[10,1:75]
CInit.marginal <- diag(0.1,91)
CInit.marginal[1:75,1:75] <- ReverseVBCopObj$CStore[,,10]
...
for(tprime in 84:266){
  ...
  ParDraws.temp <- rmvnorm(5000,mean = ReverseVBMargObj$muMAT[10000,], sigma = (ReverseVBMargObj$CArray[,,10000] %*% t(ReverseVBMargObj$CArray[,,10000]) ) )
